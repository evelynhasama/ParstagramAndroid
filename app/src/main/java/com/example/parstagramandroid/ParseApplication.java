...
public class ParseApplication extends Application {
    ...
    public static final String MY_APP_ID = "8Kto8mAiZflTSHyqVcIdyXczUwLwJXSKqzMi2wlG";
    public static final String MY_CLIENT_KEY = "XGUuNMQbFIfZJuAcHzgbZThMnMe5lwkguRagWb2x";
